      ...
      <div className="text-center max-w-md px-4">
        ...
        <div className="flex gap-3 justify-center">
          <button
            ...
            className="inline-flex items-center justify-center rounded-md bg-[var(--brand-green)] px-4 py-2 text-sm font-medium text-white hover:bg-[var(--brand-green-deep)]"
          >
            Try again
          </button>
  ...
  head: () => ({
    meta: [
      ...
      { title: "DNS Business Group — We Go Above The Limit" },
      {
        name: "description",
        content:
          "DNS Business Group is a diversified South African company spanning transport, outdoor advertising, manufacturing and travel.",
      },
